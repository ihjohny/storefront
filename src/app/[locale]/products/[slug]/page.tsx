  ...
  return (
    <main className="mx-auto w-full max-w-7xl space-y-10 px-4 py-8 sm:px-6 lg:px-8">
      <ProductDetail
        ...
        bundleIncludesTitle={dict.product.bundleIncludesTitle}
        bundleRegularTotalLabel={dict.product.bundleRegularTotal}
        bundleYouPayLabel={dict.product.bundleYouPay}
        bundleYouSaveLabel={dict.product.bundleYouSave}
        bundleItemFallbackLabel={dict.product.bundleItemFallback}
        bundleItemQtyLabel={dict.product.bundleQty}
        bundleViewDetailsLabel={dict.product.bundleViewDetails}
        bundleItemDialogTitle={dict.product.bundleItemDialogTitle}
        bundleItemViewOnlyNotice={dict.product.bundleViewOnlyNotice}
        bundleGoToProductLabel={dict.product.bundleGoToProduct}
        bundleItemCloseLabel={dict.catalog.quickView.close}
        bundleItemSkuLabel={dict.product.bundleItemSku}
        bundleItemUnitPriceLabel={dict.product.bundleItemUnitPrice}
